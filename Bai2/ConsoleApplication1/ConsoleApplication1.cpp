...
//mã nguồn biên dịch vertexshader
...
"}\0";
//mã nguồn biên dịch fragmentShader
const GLchar* fragmentShaderSource = "#version 330 core\n"
"out vec4 color;\n"
"void main()\n"
"{\n"
"color= vec4(0.0f,1.0f,1.0f,1.0f);\n"  //1.0f thứ tư là hệ số alpha 
"}\0";
//mã nguồn biên dịch vertexshader
...
int main(void)
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Hello Tam Giac", nullptr, nullptr);
	if (window == nullptr)
	{
...
#pragma endregion
	...
	GLfloat vertices[] = {
		// tam giac 1
		-0.5f,0.0f,0.0f,  //bottom-left x,y,z của tọa độ 1
...
//unbind VAO
	...
	GLfloat vertices1[] = {
		// tam giac 1
		0.0f,0.0f,0.0f,  //bottom-left x,y,z của tọa độ 1
	...
	GLuint VBO1;
	glGenBuffers(1, &VBO1);
	glBindBuffer(GL_ARRAY_BUFFER, VBO1); // liên kết (bind) VBO
	//sao chep du lieu vertices vao bo nho
...
//Đây là 2d thì có 1 trục tọa độ ở giữa
